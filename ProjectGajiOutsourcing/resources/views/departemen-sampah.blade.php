...
@section('content')
  ...
  <h3 class="mt-4">Sampah Departemen</h3>
  ...
  <div class="d-flex align-items-center mb-3 gap-2">
    <a href="/departemen" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Kembali</a>
  </div>
    ...
    <tbody>
      @foreach ($data as $item)
        <tr>
          ...
          <td>
            <a href="{{ url('restore-departemen', $item->departemen_id) }}" class="btn btn-sm btn-success"
