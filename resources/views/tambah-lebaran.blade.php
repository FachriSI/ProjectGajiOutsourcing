...
@section('content')
    ...
    <div class="bg-white p-4 rounded shadow-sm mb-4 mt-4 border-start border-primary border-5">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-calendar-plus me-2 text-primary"></i> Tambah Data Lebaran</h1>
        <p class="text-muted small mb-0 mt-1">Formulir penambahan data hari raya lebaran</p>
    </div>
            ...
            <div class="card shadow-sm border-0 mb-4 border-top border-primary border-4">
                <div class="card-body">
                    <h5 class="card-title text-primary fw-bold mb-4">
                        <i class="fas fa-plus-circle me-2"></i>Data Lebaran Baru
                    </h5>
                    ...
                    <form action="/tambah-lebaran" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="tahun_hijriyah" name="tahun_hijriyah"
                                placeholder="Contoh: 1447 H" value="{{ old('tahun_hijriyah') }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="fas fa-save me-2"></i>Simpan Lebaran
                            </button>
                        </div>
                    </form>
                </div>
