...
@section('content')
    ...
    <div class="card shadow border-0 mb-4">
        <div class="card-header bg-dark text-white py-3">
            <h6 class="m-0 fw-bold"><i class="fas fa-table me-2"></i>Daftar Kuota Jam Karyawan</h6>
        </div>
        <div class="card-body">
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="{{ url('delete-kuotajam', $item->kuota_id) }}" class="btn btn-sm btn-danger btn-delete"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" onclick="return confirm('Hapus data kuota jam ini?')">
