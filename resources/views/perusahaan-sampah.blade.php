...
@section('content')
  ...
  <h3 class="mt-4">Sampah Perusahaan</h3>
  ...
  <div class="d-flex align-items-center mb-3 gap-2">
    <a href="/perusahaan" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Kembali</a>
  </div>
    ...
    <tbody>
      @foreach ($data as $item)
        <tr>
          ...
          <td>
            <a href="{{ url('restore-perusahaan', $item->perusahaan_id) }}" class="btn btn-sm btn-success"
