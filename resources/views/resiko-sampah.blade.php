...
@section('content')
  ...
  <h3 class="mt-4">Sampah Resiko</h3>
  ...
  <div class="d-flex align-items-center mb-3 gap-2">
    <a href="/resiko" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Kembali</a>
  </div>
    ...
    <tbody>
      @foreach ($data as $item)
        <tr>
          ...
          <td>
            <a href="{{ url('restore-resiko', $item->kode_resiko) }}" class="btn btn-sm btn-success"
