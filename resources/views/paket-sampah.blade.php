...
@section('content')
  ...
  <div class="d-flex align-items-center mb-3 gap-2">
    <a href="/paket" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Kembali</a>
  </div>
    ...
    <tbody>
      @foreach ($data as $item)
        <tr>
          ...
          <td>
            <a href="{{ url('restore-paket', $item->paket_id) }}" class="btn btn-sm btn-success" data-bs-toggle="tooltip"
