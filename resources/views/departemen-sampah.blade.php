...
@section('title', 'Sampah Departemen')

@section('content')

  <!-- Modern Page Header -->
  <div class="bg-white p-4 rounded shadow-sm mb-4 mt-4 border-start border-danger border-5">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-trash-alt me-2 text-danger"></i> Sampah Departemen</h1>
    <p class="text-muted small mb-0 mt-1">Daftar data departemen yang telah dihapus (Archive)</p>
  </div>
  ...
  <div class="card shadow-sm border-0 mb-4">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
      <h6 class="m-0 font-weight-bold text-danger"><i class="fas fa-archive me-2"></i>Arsip Departemen</h6>
      <a href="/departemen" class="btn btn-outline-secondary btn-sm">
            ...
            @foreach ($data as $item)
              <tr>
                ...
                <td class="text-center">
                  <a href="{{ url('restore-departemen', $item->departemen_id) }}" class="btn btn-sm btn-outline-primary"
