...
@section('content')
    ...
    <div class="bg-white p-4 rounded shadow-sm mb-4 mt-4 border-start border-primary border-5">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-building me-2 text-primary"></i> Tambah Perusahaan</h1>
        <p class="text-muted small mb-0 mt-1">Formulir penambahan data perusahaan baru</p>
    </div>
            ...
            <div class="card shadow-sm border-0 mb-4 border-top border-primary border-4">
                <div class="card-body">
                    <h5 class="card-title text-primary fw-bold mb-4">
                        <i class="fas fa-plus-circle me-2"></i>Data Perusahaan Baru
                    </h5>

                    <form class="form-horizontal form-bordered" method="post" enctype="multipart/form-data"
                        action="/tambah-perusahaan">
                        @csrf
                        <div class="mb-3">
