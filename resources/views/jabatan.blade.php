...
@section('content')
    ...
    <div class="bg-white p-4 rounded shadow-sm mb-4 mt-4">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-briefcase me-2 text-primary"></i> Tunjangan Jabatan</h1>
                <p class="text-muted small mb-0 mt-1">Kelola data tunjangan berdasarkan jabatan</p>
            </div>
            <div class="d-flex gap-2">
                @if($hasDeleted)
                    <a href="/jabatan/sampah" class="btn btn-secondary shadow-sm">
                        <i class="fas fa-trash-restore me-1"></i> Data Sampah
                    </a>
                @endif
                <a href="/gettambah-jabatan" class="btn btn-primary shadow-sm">
    ...
    <div class="card shadow border-0 mb-4">
        <div class="card-header bg-dark text-white py-3">
            <h6 class="m-0 fw-bold"><i class="fas fa-table me-2"></i>Daftar Jabatan & Tunjangan</h6>
        </div>
        <div class="card-body">
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="{{ url('delete-jabatan', $item->kode_jabatan) }}" class="btn btn-sm btn-danger btn-delete"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" onclick="return confirm('Hapus data jabatan ini?')">
