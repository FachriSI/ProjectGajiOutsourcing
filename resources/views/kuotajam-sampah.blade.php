...
@section('content')
  ...
  <div class="bg-white p-4 rounded shadow-sm mb-4 mt-4 border-start border-danger border-5">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-trash-alt me-2 text-danger"></i> Sampah Kuota Jam</h1>
    <p class="text-muted small mb-0 mt-1">Daftar data kuota jam yang telah dihapus (Archive)</p>
  </div>
  ...
  <div class="card shadow-sm border-0 mb-4">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
      <h6 class="m-0 font-weight-bold text-danger"><i class="fas fa-archive me-2"></i>Arsip Kuota Jam</h6>
      <a href="/kuotajam" class="btn btn-outline-secondary btn-sm">
            ...
            @foreach ($data as $item)
              <tr>
                ...
                <td class="text-center">
                  <a href="{{ url('restore-kuotajam', $item->kuota_id) }}" class="btn btn-sm btn-outline-primary"
