...
@section('content')
    ...
    <div class="bg-white p-4 rounded shadow-sm mb-4 mt-4 border-start border-warning border-5">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-edit me-2 text-warning"></i> Update Jabatan</h1>
        <p class="text-muted small mb-0 mt-1">Perbarui informasi data jabatan</p>
    </div>
            ...
            <div class="card shadow-sm border-0 mb-4 border-top border-warning border-4">
                <div class="card-body">
                    ...
                    <form action="/update-jabatan/{{ $dataJ->kode_jabatan }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="nama" class="form-label fw-bold text-dark">Nama Jabatan <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="nama" name="nama" value="{{ $dataJ->jabatan }}"
                                required>
                        </div>
                        <div class="mb-3">
                            <label for="tunjangan" class="form-label fw-bold text-dark">Tunjangan Jabatan</label>
